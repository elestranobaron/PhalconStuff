...
//include ('/var/www/forum/app/library/Queue/DummyServer.php');
...
class SendSpool extends Injectable
{
    ...
    public function consumeQueue()
    {
        ...
        while (true) {
            ...
            while ($this->queue->peekReady() !== false) {//BeanStalk:: au lieu de  $this->queue->

                $job = $this->queue->reserve();//$this->queue->reserve();
