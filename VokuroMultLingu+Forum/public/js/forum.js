...
var Forum = {
	...
	addCallbacks: function()
	{
		...
		if ($('textarea').length) {
			var editor = new Editor();//{'element': textarea}); // New vide au de part chose non comprise
			editor.render();
		}
...
//		$('#suggested-posts').each(function(position, element){ // Ceci me renvoie sur Vokuro
//			window.setTimeout(Forum.showSuggestedPosts, 1500);
//		});

//		$('a.categories-link').each(function(position, element){ // Ceci me renvoie sur Vokuro
//			window.setTimeout(Forum.postHistory, 1500);
//		});
