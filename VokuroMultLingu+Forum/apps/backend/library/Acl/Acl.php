<?php
namespace Test\Backend\Acl;

use Phalcon\Mvc\User\Component;
use Phalcon\Acl\Adapter\Memory as AclMemory;
use Phalcon\Acl\Role as AclRole;
use Phalcon\Acl\Resource as AclResource;
use Test\Backend\Models\Profiles;
...
class Acl extends Component
{
     ...
     * @return boolean
     */
    public function isPrivate($module, $controllerName, $action)
    {
	...
	{
		return true;
	}else if (in_array($action) and empty($pr[$module][$controller]))
	{
		return true;
	}
	return false;
    //////////////// origin:    return isset($this->privateResources[$controllerName]); // With only one parameter: action.
    }
