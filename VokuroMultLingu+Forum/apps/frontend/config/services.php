...
use Ciconia\Ciconia;
//include_once ('/var/www/forum/app/library/Queue/DummyServer.php');
//include_once ('/var/www/forum/app/library/Mail/SendSpool.php');
define('APP_PATH', '/var/www/vokuro/apps');
...
$di->set(
    ...
    function ($view, $di) use ($config) {
        ...
        $volt->setOptions(
            array(
                "compiledPath"      => APP_PATH . "/frontend/cache/volt/",
                "compiledSeparator" => "_",
...
$di->set(
    ...
    function () use ($config) {
        ...
        if ($debug) {
            ...
            $logger = new FileLogger(APP_PATH . "/frontend/logs/db.log");
...
$di->set(
    ...
    function () use ($config) {
        ...
        return new MetaDataAdapter(array(
            'metaDataDir' => APP_PATH . '/frontend/cache/metaData/'
        ));
...
$di->set(
    'router',
    function () {
        return include APP_PATH . "/frontend/config/routes.php";
    },
    true
);
    ...
    function () use ($config) {
        ...
        if ($config->application->debug) {
            ...
            return new FileCache($frontCache, array(
                "cacheDir" => APP_PATH . "/frontend/cache/views/",
                "prefix"   => "forum-cache-"
            ));
        }
    }
    ...
    function () use ($config) {
        ...
        if ($config->application->debug) {
            ...
            return new \Phalcon\Cache\Backend\File($frontCache, array(
                "cacheDir" => APP_PATH . "/frontend/cache/data/",
